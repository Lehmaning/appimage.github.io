      ...
      {% if post.layout == 'app' && post.published != 'false' %}
        <tr id="{{ post.url }}">
          <td style="vertical-align: top;">
            ...
            {% if post.icons[0] %}<img height="64" width="64" src="https://cdn.jsdelivr.net/gh/AppImage/appimage.github.io/database/{{post.icons[0]}}"/>{% else %}<img style="opacity: 0.5;" height="64" width="64" src="https://img.icons8.com/ios/1600/ios-application-placeholder.png"/>{% endif %}<br>
